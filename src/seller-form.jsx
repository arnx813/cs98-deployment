        ...
        return (
            <div className="flex flex-col justify-center items-center ">
                ...
                <div className="flex flex-col items-center gap-6">
                    ...
                    <h2 className="text-5xl ">Your seller application has been submitted</h2>
                    <p className="text-base text-gray-500">You will typically hear back in 1-2 days</p>
    ...
    case 1:
        ...
        <div className="flex flex-col justify-center items-center">
            ...
            <div className="size-14 grow-7 main-form">
                <h2 className="mt-4 text-5xl mb-6">Are you and individual or an organization?</h2>
                ...
                <RadioGroup 
                    ...
                    <div className="flex flex-col gap-4 w-[35vw]">
                        <label className="flex p-4 border-2 rounded-full cursor-pointer hover:bg-gray-50">
                            <RadioGroupItem value="Individual" id="option-one" className="mr-4"/>
                            <span className='ml-4'>Individual Hobbyist</span>
                        </label>
                        <label className="flex p-4 border-2 rounded-full cursor-pointer hover:bg-gray-50">
                            <RadioGroupItem value="organization" id="option-two" className="mr-4"/>
    ...
    case 2:
        return (
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="size-14 grow-7 main-form">
                <div>
                    <h2 className="mt-4 text-5xl mb-6">Where do you get your datasets?</h2>
    ...
    case 4:
        return (
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="size-14 grow-7 main-form">
                <div>
                    <h2 className="mt-4 text-5xl mb-6">Please upload any material that will help us verify you as a seller</h2>
                    <p className="mb-6 text-base text-gray-500">
                    This information helps us better understand your background
                    </p>
            ...
            {!isCompleted && (
                <>
                    <div className="flex flex-row mx-8">
                        <div className="grow">
                            <Progress value={currentStep >= 1 ? 100 : 0} className="w-[99%] h-[10px] rounded-none" />
                        </div>
                        <div className="grow">
                            <Progress value={currentStep >= 2 ? 100 : 0} className="w-[99%] h-[10px] rounded-none" />
                        </div>
                        <div className="grow">
                            <Progress value={currentStep >= 3 ? 100 : 0} className="w-[99%] h-[10px] rounded-none" />
                        </div>
                        <div className="grow">
                            <Progress value={currentStep >= 4 ? 100 : 0} className="w-[99%] h-[10px] rounded-none" />
                        </div>
                        </div>
                        
                        <div className="flex flex-row mx-8">
                        <div>
                            <Button variant="link" onClick={handleBack} disabled={currentStep === 1}>
                            Back
                            </Button>
                        </div>
