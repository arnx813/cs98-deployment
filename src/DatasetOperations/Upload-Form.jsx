              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Tell us a bit about the data.
"
                    ...
                    <FormControl>
                      <div className="grid w-full max-w-sm items-center gap-0">
                        <div className="flex items-center gap-0">
                          ...
                          >
                            <Icons.Upload className="mr-2 h-4 w-4" /> Choose a
                            File
                          </Button>
                          <Input
                            ref={zipInputRef}
                    ...
                    <FormControl>
                      <>
                        <div className="flex flex-nowrap items-center">
                          ...
                          >
                            <Icons.Upload className="mr-2 h-4 w-4" /> Select
                            Preview Images
                          </Button>
                          <Input
                            ref={fileInputRef}
