        ...
        <Card className="mx-auto max-w-sm ">
          ...
          <CardContent>
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <Link
                    to="#"
                    className="ml-auto inline-block text-sm underline text-foreground hover:text-card-foreground"
                  >
              ...
              <Button
                type="submit"
                disabled={isGLoading || isLoading}
                className="w-full hover:border-input"
              >
                Login
                {isLoading && (
            ...
            <div className="mt-4 text-center text-sm">
              ...
              <Link
                to="/"
                className="underline text-card-foreground hover:text-card-foreground"
              >
                Sign up
              </Link>
            </div>
